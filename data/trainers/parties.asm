...
RedGroup:
	...
	db 11, LAPRAS,		LEFTOVERS,		ICE_BEAM, SURF, BODY_SLAM, RAIN_DANCE
	db 11, ZAPDOS,		MAGNET,			DRILL_PECK, LIGHT_SCREEN, THUNDERBOLT, THUNDER
	db 11, HYPNO,		TWISTEDSPOON,	PSYCHIC_M,	REFLECT, SHADOW_BALL,  HEADBUTT
	db 11, GOLEM,   	SOFT_SAND,		EARTHQUAKE, ROCK_SLIDE, STRENGTH, EXPLOSION	
	db 11, VENUSAUR, 	MIRACLE_SEED,	LEECH_SEED, GIGA_DRAIN, SUNNY_DAY, SOLARBEAM
	db 11, CHARIZARD,  	CHARCOAL,		FLAMETHROWER, WING_ATTACK, SLASH, FIRE_BLAST
	db -1 ; end
