...
Rival1Group:
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 30, GOLBAT,     NO_ITEM,			LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, MAGNEMITE,  NO_ITEM,			TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, HAUNTER,    NO_ITEM,			LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    MIRACLEBERRY,	LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, MEGANIUM,   GOLD_BERRY,		REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 30, HAUNTER,    NO_ITEM,			LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    MIRACLEBERRY,	LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, QUILAVA,    GOLD_BERRY,		SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    NO_ITEM,			LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    MIRACLEBERRY,	LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, GOLD_BERRY,		RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, HAUNTER,    NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    NO_ITEM,			DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TYPHLOSION, GOLD_BERRY,		SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 34, SNEASEL,    MIRACLEBERRY,	QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     NO_ITEM,			LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   NO_ITEM,			THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    NO_ITEM,			DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, GOLD_BERRY,		RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
