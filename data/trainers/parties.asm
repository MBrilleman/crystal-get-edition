...
FalknerGroup:
	...
	db 10, MURKROW,	PECK, THIEF, NO_MOVE, NO_MOVE
	db 10, NATU,	PECK, LEER, NIGHT_SHADE, NO_MOVE
	db 12, HOOTHOOT,	TACKLE, GROWL, FORESIGHT, PECK
	db -1 ; end
...
WhitneyGroup:
	...
	db 18, TEDDIURSA, 		LICK, FURY_SWIPES, LEER, FIRE_PUNCH
...
BugsyGroup:
	...
	db 15, PINSIR, 	VICEGRIP, FURY_CUTTER, NO_MOVE, NO_MOVE
	db 15, YANMA,	LEECH_LIFE, QUICK_ATTACK,GIGA_DRAIN, NO_MOVE
...
MortyGroup:
	...
	db 24, MISDREAVUS, GROWL, PSYWAVE, SHADOW_BALL, NIGHTMARE
	db 24, ARIADOS, 	LEECH_LIFE, NIGHT_SHADE, POISON_STING, CONSTRICT
...
PryceGroup:
    ...
    db 35, SNEASEL, 	FAINT_ATTACK, ICE_PUNCH, SCREECH, SCRATCH
	db 35, CLOYSTER,   	AURORA_BEAM, PROTECT, BUBBLEBEAM, WITHDRAW
	db 35, DEWGONG,	HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 35, DELIBIRD,	PRESENT, AURORA_BEAM, ICY_WIND, FLY
    db 37, SMOOCHUM,	PSYCHIC_M, POWDER_SNOW, SING, SWEET_KISS
	db 37, PILOSWINE,  ICY_WIND, FURY_ATTACK, MUD_SLAP, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 32, SCIZOR,  	AGILITY, METAL_CLAW, HEADBUTT, FURY_CUTTER
	db 32, FORRETRESS, 	SELFDESTRUCT, SPIKES, GIGA_DRAIN, TAKE_DOWN
	db 32, MAGNETON,  THUNDERSHOCK, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 32, SKARMORY,  PECK, STEEL_WING, AGILITY,  SWIFT
...
ChuckGroup:
    ...
    db 31, TYROGUE,	HI_JUMP_KICK, MACH_PUNCH, RAPID_SPIN, STRENGTH
    db 30, PRIMEAPE, 	LEER, RAGE, KARATE_CHOP, FURY_SWIPES
    db 30, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db 30, HERACROSS,   HORN_ATTACK, FURY_CUTTER, REVERSAL, ROCK_SMASH
    db 32, HITMONTOP,   ROLLING_KICK, FOCUS_ENERGY, PURSUIT, QUICK_ATTACK
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 38, GYARADOS,  SURF, DRAGON_RAGE, HEADBUTT, LEER
	db 38, CHARMELEON,  DRAGONBREATH, FLAMETHROWER, SCARY_FACE, MUD_SLAP
...
Rival1Group:
	...
	db 12, GASTLY,		NO_ITEM
	db 14, ZUBAT,		NO_ITEM
	db 16, CROCONAW,	BERRY
	db -1 ; end

	; RIVAL1 (7)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 20, HAUNTER,		NO_ITEM,    LICK, SPITE, MEAN_LOOK, CURSE
	db 18, MAGNEMITE,  	NO_ITEM,	TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,  		NO_ITEM,	LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, BAYLEEF,     BERRY,		GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 18, MAGNEMITE,   NO_ITEM,	TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,       NO_ITEM,	LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, QUILAVA,    	BERRY,		LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 18, MAGNEMITE,  NO_ITEM,		TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      NO_ITEM,		LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   BERRY,		LEER, RAGE, WATER_GUN, BITE
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 34, GOLBAT,     NO_ITEM,			LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   NO_ITEM,			TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 34, HAUNTER,    NO_ITEM,			LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 36, SNEASEL,    MIRACLEBERRY,	LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 37, MEGANIUM,   GOLD_BERRY,		REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 34, HAUNTER,    NO_ITEM,			LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 36, SNEASEL,    MIRACLEBERRY,	LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 37, TYPHLOSION, GOLD_BERRY,		SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 34, HAUNTER,    NO_ITEM,			LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 36, SNEASEL,    MIRACLEBERRY,	LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 37, FERALIGATR, GOLD_BERRY,		RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 34, SNEASEL,    MIRACLEBERRY,	QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     NO_ITEM,			LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 35, MAGNETON,   NO_ITEM,			THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    NO_ITEM,			DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, MEGANIUM,   GOLD_BERRY,		REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end

	; RIVAL1 (14)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 40, SNEASEL,    MIRACLEBERRY,	QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 40, CROBAT,     NO_ITEM,			LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 40, MAGNETON,   NO_ITEM,			THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 40, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 40, ALAKAZAM,   NO_ITEM,			DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 42, TYPHLOSION, GOLD_BERRY,		SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 40, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 40, ALAKAZAM,   NO_ITEM,			DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 42, FERALIGATR, GOLD_BERRY,		RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 43, GIRAFARIG,	PSYBEAM, STOMP, SHADOW_BALL, BEAT_UP
	db 44, JYNX,   	DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 44, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 44, SLOWKING,	CURSE, STOMP, CONFUSION, AMNESIA
...
BrunoGroup:
    ...
    db 45, DONPHAN,	DEFENSE_CURL, ROLLOUT, ANCIENTPOWER, BODY_SLAM
    db 46, HITMONTOP,  PURSUIT, QUICK_ATTACK, DIG, DETECT
...
KarenGroup:
	...
	db 47, GLIGAR, 	FAINT_ATTACK, SLASH, SCREECH, SLUDGE_BOMB
	db 47, GENGAR, 	SHADOW_BALL, SPITE, CURSE, DESTINY_BOND
	db 47, URSARING,	FAINT_ATTACK, REST, SNORE, SLASH
	db 48, HOUNDOOM,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end
...
KogaGroup:
	...
	db 44, ARIADOS,	    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 45, VENOMOTH,    SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 45, ARBOK,       PROTECT, CRUNCH, SLUDGE_BOMB, TOXIC
...
ChampionGroup:
	...
	db 46, TYRANITAR,  CRUNCH, ROCK_SLIDE, SCREECH, HYPER_BEAM
...
BrockGroup:
	...
	db 64, NINETALES,	FLAMETHROWER, DIG, CONFUSE_RAY, FIRE_SPIN
	db 64, CROBAT,	WING_ATTACK, STEEL_WING, BITE, QUICK_ATTACK
	db 64, SUDOWOODO, ROCK_SLIDE, EARTHQUAKE, LOW_KICK, FLAIL
	db 65, STEELIX, 	EARTHQUAKE, ROCK_SLIDE, STRENGTH, IRON_TAIL
	db 64, FORRETRESS,	SPIKES, SANDSTORM, PIN_MISSILE, ROLLOUT
	db 64, KABUTOPS,   SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 62, POLITOED, 	RAIN_DANCE, SWAGGER, SURF, ICY_WIND
	db 63, GYARADOS,	THUNDER, HYDRO_PUMP, HYPER_BEAM, TWISTER
	db 62, PSYDUCK,	HYDRO_PUMP, PSYCHIC_M, LIGHT_SCREEN, DISABLE
	db 62, TOGETIC,	METRONOME, FLY, SWIFT, NO_MOVE
	db 62, QUAGSIRE,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 62, CORSOLA,	BUBBLEBEAM, EARTHQUAKE, ANCIENTPOWER, RECOVER
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 52, LANTURN,	RAIN_DANCE, THUNDER, WATERFALL, FLAIL
	...
	db 52, AMPHAROS,  THUNDERPUNCH, FIRE_PUNCH, LIGHT_SCREEN, COTTON_SPORE
...
ErikaGroup:
    ...
    db 56, SUNFLORA,	PETAL_DANCE, GIGA_DRAIN, SLUDGE_BOMB, GROWTH
    db 57, VENUSAUR, SOLARBEAM, SYNTHESIS, RAZOR_LEAF, GROWTH
	db -1 ; end
...
JanineGroup:
	...
	db 59, ARBOK,	CRUNCH, SLUDGE_BOMB, TOXIC, BODY_SLAM
    db 59, GLIGAR,	FAINT_ATTACK, SLASH, SLUDGE_BOMB, EARTHQUAKE
...
BeautyGroup:
	...
	db 17, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	db 17, MEOWTH,     SCRATCH, GROWL, BITE, SLASH
	db -1 ; end
...
SabrinaGroup:
	...
	db 54, GENGAR,	HYPNOSIS, DREAM_EATER,PSYCHIC_M, NIGHTMARE
	db 54, EXEGGUTOR,	GIGA_DRAIN, PSYCHIC_M, EGG_BOMB, REST
	db 54, WOBBUFFET,	COUNTER, MIRROR_COAT, DESTINY_BOND, SAFEGUARD
	db -1 ; end
...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 41, SNEASEL,    MIRACLEBERRY,	QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 42, GOLBAT,     NO_ITEM,			LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 41, MAGNETON,   NO_ITEM,			THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 43, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   NO_ITEM,			DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, MEGANIUM,   GOLD_BERRY,		RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 43, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   NO_ITEM,			DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, TYPHLOSION, GOLD_BERRY,		SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 43, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   NO_ITEM,			DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, GOLD_BERRY,		RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end

	; RIVAL2 (4)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 45, SNEASEL,    MIRACLEBERRY,	QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 48, CROBAT,     NO_ITEM,			TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 45, MAGNETON,   NO_ITEM,			THUNDER, SONICBOOM, THUNDER_WAVE, SWIFT
	db 46, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   NO_ITEM,			RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, MEGANIUM,   GOLD_BERRY,		GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 46, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   NO_ITEM,			RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, TYPHLOSION, GOLD_BERRY,		SMOKESCREEN, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 46, GENGAR,     NO_ITEM,			MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   NO_ITEM,			RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, FERALIGATR, GOLD_BERRY,		SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
BlaineGroup:
	...
	db 66, MAGCARGO,   CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
	db 66, MAGMAR, 	THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 66, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db 67, HOUNDOOM,	FLAMETHROWER, CRUNCH, SWAGGER, SMOG
	db 66,  ARCANINE,	EXTREMESPEED,	FIRE_BLAST,	FLAMETHROWER, AGILITY
	db 66, FLAREON,	FLAMETHROWER, BITE, QUICK_ATTACK, SWIFT
	db -1 ; end
...
PokefanMGroup:
	...
	db 50, RAICHU,    BERRY
	db 51, ELECTABUZZ,    BERRY
	db 51, AMPHAROS,    BERRY
	db 51, TOGEPI,    BERRY
	db 50, EEVEE,    BERRY
	db 52, MARILL,    BERRY
	db -1 ; end
	...
	db 60, IVYSAUR,  BERRY
	db 60, CHARMELEON, BERRY
	db 60, WARTORTLE,   BERRY
	db -1 ; end
...
RedGroup:
    ...
    ; RED (2)
	; Maarten / Marcus / Rob 
	db "MARCUS@", TRAINERTYPE_ITEM_MOVES
	db 88, LAPRAS,		LEFTOVERS,		ICE_BEAM, SURF, BODY_SLAM, RAIN_DANCE
	db 88, ZAPDOS,		MAGNET,			DRILL_PECK, LIGHT_SCREEN, THUNDERBOLT, THUNDER
	db 88, HYPNO,		TWISTEDSPOON,	PSYCHIC_M,	REFLECT, SHADOW_BALL,  HEADBUTT
	db 88, GOLEM,   	SOFT_SAND,		EARTHQUAKE, ROCK_SLIDE, STRENGTH, EXPLOSION	
	db 88, VENUSAUR, 	MIRACLE_SEED,	LEECH_SEED, GIGA_DRAIN, SUNNY_DAY, SOLARBEAM
	db 88, CHARIZARD,  	CHARCOAL,		FLAMETHROWER, WING_ATTACK, SLASH, FIRE_BLAST
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "MarcRob@", TRAINERTYPE_MOVES
    db 69, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	db 69, ARCANINE,   ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db 69, RHYDON, 	FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 69, UMBREON,	BITE, MOONLIGHT, QUICK_ATTACK, SAND_ATTACK
	db 69, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 69, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db -1 ; end
...
MysticalmanGroup:
	...
	; MYSTICALMAN (2)
	db "BOY@", TRAINERTYPE_MOVES
	db 20, BLISSEY,    BELLY_DRUM, BELLY_DRUM, BELLY_DRUM, BELLY_DRUM
	db -1 ; end

	; MYSTICALMAN (3)
	db "BLOKE@", TRAINERTYPE_MOVES
	db 40, BLISSEY,    BELLY_DRUM, BELLY_DRUM, BELLY_DRUM, BELLY_DRUM
	db 40, BLISSEY,    BELLY_DRUM, BELLY_DRUM, BELLY_DRUM, BELLY_DRUM
	db -1 ; end

	; MYSTICALMAN (4)
	db "MAN@", TRAINERTYPE_MOVES
	db 60, BLISSEY,    BELLY_DRUM, BELLY_DRUM, BELLY_DRUM, BELLY_DRUM
	db 60, BLISSEY,    BELLY_DRUM, BELLY_DRUM, BELLY_DRUM, BELLY_DRUM
	db 60, BLISSEY,    BELLY_DRUM, BELLY_DRUM, BELLY_DRUM, BELLY_DRUM
	db -1 ; end